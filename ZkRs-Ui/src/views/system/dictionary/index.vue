<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="目录名称" prop="zdName">
        <el-input
    ...
    <el-table v-loading="loading" :data="dictionaryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="目录名称" align="center" prop="zdName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item  prop="zdName"  hidden="hidden" >
          <el-input v-model="form.id" placeholder="请输入字典名称" />
        </el-form-item>

        <el-form-item label="目录名称" prop="zdName">
          <el-input v-model="form.zdName" placeholder="请输入目录名称" />
        </el-form-item>
