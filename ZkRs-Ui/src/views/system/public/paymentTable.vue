    ...
    <div >
      ...
      <div style="width: 100%" >
        ...
        >
          ...
          <el-table-column label="时间" align="center" prop="times"  width="250">
            <template slot-scope="scope">   <!-- 金额保留2位下手-->
              <el-date-picker  v-model="bcglXiangXiList[scope.row.xh-1].times" type="date" placeholder="选择时间"   format="yyyy-MM" value-format="yyyy-MM-dd"></el-date-picker>
            </template>
          </el-table-column>
          <el-table-column label="金额" align="center" prop="january" width="250">
            <template slot-scope="scope">
              <el-input v-model="bcglXiangXiList[scope.row.xh-1].january" maxlength="10"  onkeyup="value=value.replace(/^\D*(\d*(?:\.\d{0,4})?).*$/g, '$1')"
              />
            </template>
          </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      importTemplate() {
        ...
        this.download('/system/date/downloadTemplate', {
